...
<tileset version="1.10" tiledversion="1.11.2" name="Grass" tilewidth="32" tileheight="32" tilecount="64" columns="8">
 ...
 <tile id="21" probability="0.1"/>
 <tile id="22" probability="0.1"/>
 <tile id="23" probability="0.1"/>
 <tile id="28" probability="0.1"/>
 <tile id="29" probability="0.1"/>
 <tile id="30" probability="0.1"/>
 <tile id="31" probability="0.1"/>
 <wangsets>
  <wangset name="Grass_Tiles" type="corner" tile="-1">
   <wangcolor name="GrassTiles" color="#ff0000" tile="-1" probability="1"/>
